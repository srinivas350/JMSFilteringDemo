package com.example.claimmanagement;
...
public class ClaimManagement {
	...
	public static void main(String[] args) throws NamingException, JMSException {
		...
		try  {
			...
			JMSConsumer consumer = jmsContext.createConsumer(requestQueue, "doctorType IN ('gyna','psych') OR JMSPriority BETWEEN 5 AND 9");
			...
			objectMessage.setStringProperty("doctorType", "dentist");
